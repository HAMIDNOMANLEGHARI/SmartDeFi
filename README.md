...
Live Demo: smart-de-fi.vercel.app #APP LINK
...
Open http://localhost:3000 with your browser to see the result. The application will auto-update as you modify files in the src/app directory.
